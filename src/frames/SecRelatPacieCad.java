 ...
 * @author zEveerY
 */
public class SecRelatPacieCad extends javax.swing.JFrame {

    PacienteDAO pacienteDAO = new PacienteDAO();
    
    /**
     * Creates new form SecRelatPacieCad
     */
    public SecRelatPacieCad() {
        initComponents();
    }
    ...
    private void jb_visualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_visualizarActionPerformed
        ...
        try {
            JasperPrint rel = JasperFillManager.fillReport("C:\\Users\\zEveerY\\Documents\\NetBeansProjects\\ConsultorioMedico\\src\\reports\\PacienCad.jasper", map, pacienteDAO.getConnection());
            JasperViewer f = new JasperViewer(rel);
            f.show(true);
        } catch (JRException ex) {
            Logger.getLogger(SecRelatPacieCad.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecRelatPacieCad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecRelatPacieCad().setVisible(true);
            }
        });
    }
