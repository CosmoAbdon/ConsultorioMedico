 ...
 * @author zEveerY
 */
public class SecAlterarPacientesModal extends java.awt.Dialog {
PacienteDAO pacienteDAO = new PacienteDAO();
Paciente paciente = new Paciente();
ConvenioDAO convenioDAO = new ConvenioDAO();
Convenio convenio = new Convenio();
    /**
     * Creates new form SecAlterarPacientesModal
     */
    public SecAlterarPacientesModal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        preencher_jcomboBox();
    }
    ...
    private void initComponents() {
        ...
        jcb_convenio1 = new javax.swing.JComboBox();
        jl_convenio = new javax.swing.JLabel();
        ...
        jl_cadastrar1.setText("Alterar Pacientes");
        ...
        jl_convenio.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jl_convenio.setText("Convênio :");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jl_convenio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(jl_nome1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jcb_sexo1, 0, 225, Short.MAX_VALUE)
                            .addComponent(jtf_endereco1)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jcb_convenio1, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(26, 26, 26)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jl_convenio)
                            .addComponent(jcb_convenio1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        setBounds((screenSize.width-667)/2, (screenSize.height-458)/2, 667, 458);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SecAlterarPacientesModal dialog = new SecAlterarPacientesModal(new java.awt.Frame(), true);
    ...
    private javax.swing.JComboBox jcb_convenio1;
    private javax.swing.JComboBox jcb_sexo1;
    private javax.swing.JLabel jl_cadastrar1;
    private javax.swing.JLabel jl_convenio;
...
private void cadastrar() throws SQLException {
        ...
        paciente.setNome(jtf_endereco1.getText());
        paciente.setEndereco(jtf_endereco1.getText());
        ...
        paciente.setConvenio(jcb_convenio1.getSelectedItem().toString());
